const data = [
	...
	},
	{
          id:8,
		  name:"Sangam",
		  info:"The Prayagraj Fort, also known as Allahabad Fort, was built in 1583 by Mughal emperor Akbar on the banks of the Yamuna near the sacred Triveni Sangam in Prayagraj, Uttar Pradesh. Considered Akbar’s               largest fort, it houses historic structures like the Ashoka Pillar, the sacred Akshayavat (immortal banyan tree), and the Patalpuri Temple. Though parts of the fort are now under the control of the Indian Army and restricted to the public, visitors can still explore some sections and witness its blend of Mughal architecture and religious heritage. Its location near the Sangam makes it both a historical monument and an important pilgrimage site.",
		  image:"https://res.cloudinary.com/dsmtqltr5/image/upload/v1758999055/sangam_hsr7iz.jpg",
		  price:"₹58,765",
	},
];
